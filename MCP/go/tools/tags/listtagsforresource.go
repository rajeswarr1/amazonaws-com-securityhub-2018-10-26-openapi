...
func CreateListtagsforresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_tags_ResourceArn",
		mcp.WithDescription("Returns a list of tags associated with a resource."),
		mcp.WithString("ResourceArn", mcp.Required(), mcp.Description("The ARN of the resource to retrieve tags for.")),
	)
